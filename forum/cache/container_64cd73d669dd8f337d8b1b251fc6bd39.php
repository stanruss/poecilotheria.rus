...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'u0179767_stan', 'stan818791', 'u0179767_poec', '', false, false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'dbal.dbuser' => 'u0179767_stan',
            'dbal.dbpasswd' => 'stan818791',
            'dbal.dbname' => 'u0179767_poec',
            'dbal.dbport' => '',
            'dbal.new_link' => false,
        );
    }
